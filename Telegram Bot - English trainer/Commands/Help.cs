...
{
    /// <summary>
    /// Показывает справку о работе робота
    /// </summary>
    internal class Help : Command, ICommand
    {
        ...
        public Help()
        {
            ...
            Content = "*Инструкция по работе с роботом-тренером*" +
                ...
                "\nЛогика строится на структуре команд, типа меню и подменю. Доступные команды генерируются исходя из того в каком меню или подменю вы находитесь" ;
        }
